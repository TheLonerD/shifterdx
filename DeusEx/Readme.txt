...
UPDATES:
	...
	v1.8.3:
	 ...
	 - Changed the Demo detection algorithm so that it doesn't falsely read
	the Steam version as the Demo version.  Apparently the Steam version
	doesn't always allow the game to read the contents of the Maps dir,
	which is how the Demo check works.
